...
export const SignatureHeader = forwardRef<HTMLElement, SignatureHeaderProps>(
  function SignatureHeader({ showStatus = true, className }, ref) {
    return (
      <header
        ref={ref}
        className={`signature-header${className ? ` ${className}` : ""}`}
      >
